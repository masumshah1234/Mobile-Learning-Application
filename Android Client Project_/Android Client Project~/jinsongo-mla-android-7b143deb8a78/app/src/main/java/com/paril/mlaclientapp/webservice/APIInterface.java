...
public interface APIInterface {
    ...
    @POST("api/Admin/PostAdminPublicKey")
    Call<MLAAdminDetails> addAdminPublicKey(@Query("publickey") String publickey, @Query("userName") String userName);

    @POST("api/Register/PostStudentPublicKey")
    Call<MLAStudentDetails> addStudentPublicKey(@Query("publickey") String publickey, @Query("userName") String userName);

    @POST("api/Register/PostInstructorPublicKey")
    Call<MLAInstructorDetails> addInstructorPublicKey(@Query("publickey") String publickey, @Query("userName") String userName);
    ...
    @GET("api/Chat/GetAllChat")
    Call<List<MlaChat>> getMessage(@Query("receiver") String receiver);
    @POST("api/Chat/PostChat")
    Call<MlaChat> postmessage(@Query("messagedate") String messagedate, @Query("text") String text, @Query("receiver") String receiver, @Query("sender") String sender);
