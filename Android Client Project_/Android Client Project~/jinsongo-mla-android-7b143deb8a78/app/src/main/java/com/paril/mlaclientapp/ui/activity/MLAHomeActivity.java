...
import com.paril.mlaclientapp.ui.fragment.MLAChatFragment;
...
import com.paril.mlaclientapp.ui.fragment.ReceiveMessageFragment;
                ...
                if (expandableListView.getExpandableListAdapter().getChildrenCount(groupPosition) == 0) {
                    if (lastGroupSelPos != groupPosition) {
                        if (listPrimary.get(groupPosition).equals("Home")) {
                            ...
                            fragmentTransaction.commit();}
                            else if(listPrimary.get(groupPosition).equals("Send New Message")) {
                            setToolbarTitle("Outgoing");
                            MLAChatFragment mlaChatFragment = new MLAChatFragment();
                            FragmentManager fragmentManager = getFragmentManager();
                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                            fragmentTransaction.replace(R.id.mla_fragmentholder, mlaChatFragment);
                            fragmentTransaction.commit();
                        }
                        else if(listPrimary.get(groupPosition).equals("Inbox")) {
                            setToolbarTitle("Incoming");
                            ReceiveMessageFragment receiveMessageFragment = new ReceiveMessageFragment();
                            FragmentManager fragmentManager = getFragmentManager();
                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                            fragmentTransaction.replace(R.id.mla_fragmentholder, receiveMessageFragment);
                            fragmentTransaction.commit();
        ...
        listExpandable.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                if (lastGroupSelPos != groupPosition || lastChildSelPos != childPosition) {
                    ...
                    if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("New Message") && listPrimary.get(groupPosition).equals("Chat Messanger")) {
                        setToolbarTitle("Outgoing Message");
                        MLAEnrollStudentViewFragment MLAEnrollStudentViewFragment = new MLAEnrollStudentViewFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, MLAEnrollStudentViewFragment);
                    ...
                    if (listHashMap.get(listPrimary.get(groupPosition)).get(childPosition).getTxtView().equals("Inbox") && listPrimary.get(groupPosition).equals("Chat Messanger")) {
                        setToolbarTitle("Incoming Message");
                        MLAEnrollStudentViewFragment MLAEnrollStudentViewFragment = new MLAEnrollStudentViewFragment();
                        FragmentManager fragmentManager = getFragmentManager();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.replace(R.id.mla_fragmentholder, MLAEnrollStudentViewFragment);
