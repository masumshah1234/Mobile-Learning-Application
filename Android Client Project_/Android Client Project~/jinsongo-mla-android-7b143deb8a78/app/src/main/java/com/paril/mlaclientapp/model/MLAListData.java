...
public class MLAListData {
    ...
    public HashMap<String,List<MLAListModel>> getlist()  {
        ...
        if(userType.equals("admin"))
        {
            ...
            List<MLAListModel> Chat = new ArrayList<>();
            List<MLAListModel> receive = new ArrayList<>();
            ...
            navDrawerHashMap.put("Send New Message", Chat);
            navDrawerHashMap.put("Inbox",receive);
