...
namespace MlaWebApi.Controllers
{
    public class AdminController : ApiController
    {
        ...
        public HttpResponseMessage PostAdminPublicKey(string publickey, string userName)
        {
            ...
            admin.idAdmin = userName;

            try
            {
                SqlCommand comm = new SqlCommand("Update admin set publickey ='" + publickey + "'" + " where idAdmin = '" + userName + "'", cnn);
                SqlDataAdapter sqlada = new SqlDataAdapter(comm);
                sqlada.Fill(dsData);
