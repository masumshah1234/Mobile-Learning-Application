...
namespace MlaWebApi.Controllers
{
    public class InstructorController : ApiController
    {
        ...
        public HttpResponseMessage PostInstructorPublicKey(string publickey, string userName)
        {
            ...
            instructor.idInstructor = userName;

            try
            {
                SqlCommand comm = new SqlCommand("Update instructor set publickey ='" + publickey + "'" + " where idInstructor = '" + userName + "'", cnn);
                SqlDataAdapter sqlada = new SqlDataAdapter(comm);
                sqlada.Fill(dsData);
