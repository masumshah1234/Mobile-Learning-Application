...
namespace MlaWebApi.Controllers
{
    public class StudentController : ApiController
    {
        ...
        public HttpResponseMessage PostStudentPublicKey(string publickey, string userName)
        {
            ...
            student.idStudent = userName;

            try
            {
                SqlCommand comm = new SqlCommand("Update student set publickey ='" + publickey + "'" + " where idStudent = '" + userName + "'", cnn);
                SqlDataAdapter sqlada = new SqlDataAdapter(comm);
                sqlada.Fill(dsData);
